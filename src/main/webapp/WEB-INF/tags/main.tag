...
<head>
    ...
    <link rel="icon" href="${pageContext.request.contextPath}/Public/images/logoCooky.jpg" type="image/x-icon">
...
<div id="wrapper">
    <div id="header" class="navbar-toggleable-md clearfix">
        <header id="topNav">
            <div class="container">
                ...
                <a class="logo float-left" href="${pageContext.request.contextPath}/home/index">
                    <img src="${pageContext.request.contextPath}/Public/images/logoCooky.jpg"/>
                </a>
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <img src="${pageContext.request.contextPath}/Public/images/logoCooky.jpg" class="footer-logo" style="width: 80%">
