                ...
                <div class="row">
                    <div class="col-md-3 col-xs-6">
                        <div class="text-center">
                            <a href="${pageContext.request.contextPath}/category/index"><i class="ico-light ico-lg ico-rounded ico-hover et-tools"></i></a>
                            <a href="${pageContext.request.contextPath}/category/index"><h4>BMI & Calo calculation</h4></a>
